...
const rows = [
	...
	createData('Jelly Belly', 375, 0.0),
	createData('Jellians', 375, 0.0),
	createData('Jell snow', 375, 0.0),
...
export default function EnhancedTable() {
	...
	function buscaFiltroHandler() {
		...
		setInitialList(oldList);
	}

	function verifyText(text) {
		if (text.length >= 4) {
			console.log('okay para buscar');
			setInitialList(
				oldList.filter((item) => {
					return item.name
						.toUpperCase()
